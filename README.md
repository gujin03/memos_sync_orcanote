...
A Orca Note plugin that syncs Memos notes into journals.

## Usage

1. Download the zip file and extract it into Orca Note's `plugins` directory.
2. Start/restart Orca Note, enable the plugin under the app's settings.
3. Configure the plugin settings with your Memos API URL and token.
4. Click the sync button in the top toolbar of Orca Note every time you want to sync new notes.
